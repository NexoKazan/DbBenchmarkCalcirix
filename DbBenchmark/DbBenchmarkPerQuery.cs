...
namespace DbBenchmark
{
    ...
    public class DbBenchmarkPerQuery
    {
        ...
        //[Params(5)] public double qNumber;

        private string host = "localhost";
        //private string host = "10.114.22.60";
        private const string LogFile = "TimeLog.txt";
        ...
        {
            File.AppendAllText(LogFile,$"{qNumber}\t{DateTime.Now:O}");
        ...
        public void Mysql()
        {
            var mySqlDatabase = new Mysql.Database(
                "User ID=root;Password=root;Host=" + host  + ";Port=3306;Database=tpch");
        ...
        {
            var pgpDatabase = new Postgres.Database(
                "User ID=postgres;Password=root;Host=" + host + ";Port=5432;Database=tpch;Pooling=true;CommandTimeout=1800");
            pgpDatabase.SelectBlocks(Queries.GetQuery(qNumber), BlockSize);
