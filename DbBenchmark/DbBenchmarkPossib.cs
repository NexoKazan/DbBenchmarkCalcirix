...
namespace DbBenchmark
{
    ...
    public class DbBenchmarkPossib
    {
        ...
        public void CalciteMysql()
        {
            ...
            for (int i = 0; i < possibSeq.Length; i++)
            {
                calciteDb.SelectBlocks(possibSeq[i], BlockSize);
            }
        }
        ...
        public void Mysql()
        {
            ...
            for (int i = 0; i < possibSeq.Length; i++)
            {
                mySqlDatabase.SelectBlocks(possibSeq[i], BlockSize);
            }
        }
        ...
        public void PostgresPROPossib()
        {
            ...
            for (int i = 0; i < possibSeq.Length; i++)
            {
                pgpDatabase.SelectBlocks(possibSeq[i], BlockSize);
            }
        }
